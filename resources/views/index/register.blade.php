        ...
        <div class="col-sm-8 col-sm-offset-2">
            ...
            <div class="wizard-container">
                ...
                <div class="card wizard-card" data-color="orange" id="wizardProfile">
                    <form data-url="{{ route('hotel.store') }}" method="POST" id="register-form">
                        {{ csrf_field() }}
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                      <div class="form-group{{ $errors->has('nom') ? ' has-error' : '' }}">
                                        ...
                                        <input name="nom" type="text" class="form-control" placeholder="..." value="{{ old('nom') }}" required="">
                                        @if ($errors->has('nom'))
                                      ...
                                      <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <input name="tel" type="text" class="form-control" placeholder="Tel..." value="{{ old('tel') }}" required>
                                        @if ($errors->has('tel'))
                                            <span class="help-block">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7 col-sm-offset-1">
                                         <div class="form-group{{ $errors->has('place') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" class="form-control" placeholder="..." name="place" value="{{ old('place') }}" required>
                                            @if ($errors->has('place'))
                                                <span class="help-block">
                                    ...
                                    <div class="col-sm-3">
                                         <div class="form-group{{ $errors->has('num_place') ? ' has-error' : '' }}">
                                            <label>Street Number</label>
                                            <input type="text" class="form-control" placeholder="---" name="num_place" value="{{ old('num_place') }}">
                                          </div>
                                          @if ($errors->has('num_place'))
                                              <span class="help-block">
                                                  <strong>{{ $errors->first('num_place') }}</strong>
                                              </span>
                                          @endif
                                    </div>
                                    ...
                                    <div class="col-sm-5">
                                         <div class="form-group{{ $errors->has('pays') ? ' has-error' : '' }}">
                                            <label>Country (required)</label><br>
                                             <select value="{{ old('pays') }}" name="pays" class="form-control">
