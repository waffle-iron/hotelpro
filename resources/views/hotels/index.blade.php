    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <img src="/images/hotel/1.jpg" alt=" " class="img-responsive">
...
<div class="about-wthree" id="about">
    <div class="container">
        <div class="ab-w3l-spa">
            ...
            <img src="/images/hotel/about.jpg" class="img-responsive" alt="Hair Salon">
            <div class="w3l-slider-img">
                <img src="/images/hotel/a1.jpg" class="img-responsive" alt="Hair Salon">
            </div>
    ...
    <div class="container">
        ...
        <div id="horizontalTab">
            <ul class="resp-tabs-list">
                <li>
                    <img src="/images/hotel/teams1.jpg" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="/images/hotel/teams2.jpg" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="/images/hotel/teams3.jpg" alt=" " class="img-responsive" />
                </li>
                <li>
                    <img src="/images/hotel/teams4.jpg" alt=" " class="img-responsive" />
                </li>
            </ul>
...
<section class="portfolio-w3ls" id="gallery">
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g1.jpg" class="swipebox"><img src="/images/hotel/g1.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g2.jpg" class="swipebox"><img src="/images/hotel/g2.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g3.jpg" class="swipebox"><img src="/images/hotel/g3.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g4.jpg" class="swipebox"><img src="/images/hotel/g4.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g5.jpg" class="swipebox"><img src="/images/hotel/g5.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g6.jpg" class="swipebox"><img src="/images/hotel/g6.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g6.jpg" class="swipebox"><img src="/images/hotel/g7.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g6.jpg" class="swipebox"><img src="/images/hotel/g8.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g9.jpg" class="swipebox"><img src="/images/hotel/g9.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="col-md-3 gallery-grid gallery1">
        <a href="/images/hotel/g10.jpg" class="swipebox"><img src="/images/hotel/g10.jpg" class="img-responsive" alt="/">
            <div class="textbox">
                <h4>Resort Inn</h4>
                <p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
            </div>
    ...
    <div class="container">
        ...
        <div class="priceing-table-main">
            <div class="col-md-3 price-grid">
                <div class="price-block agile">
                    <div class="price-gd-top">
                        <img src="/images/hotel/r1.jpg" alt=" " class="img-responsive" />
                        <h4>Deluxe Room</h4>
                    </div>
            ...
            <div class="col-md-3 price-grid ">
                <div class="price-block agile">
                    <div class="price-gd-top">
                        <img src="/images/hotel/r2.jpg" alt=" " class="img-responsive" />
                        <h4>Luxury Room</h4>
                    </div>
                    <div class="price-gd-bottom">
                        <div class="price-list">
            ...
            <div class="col-md-3 price-grid lost">
                <div class="price-block agile">
                    <div class="price-gd-top">
                        <img src="/images/hotel/r3.jpg" alt=" " class="img-responsive" />
                        <h4>Guest House</h4>
                    </div>
                    <div class="price-gd-bottom">
                        <div class="price-list">
            ...
            <div class="col-md-3 price-grid wthree lost">
                <div class="price-block agile">
                    <div class="price-gd-top ">
                        <img src="/images/hotel/r4.jpg" alt=" " class="img-responsive" />
                        <h4>Single Room</h4>
                    </div>
                    <div class="price-gd-bottom">
                        <div class="price-list">
                ...
                <ul class="slides">
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="/images/hotel/5.jpg" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="/images/hotel/c1.jpg" alt=" " class="img-responsive" />
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="/images/hotel/5.jpg" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="/images/hotel/c2.jpg" alt=" " class="img-responsive" />
                            </div>
                        </div>
                        <div class="w3layouts_work_grid_right">
                            <h4>
                    ...
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="/images/hotel/5.jpg" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="/images/hotel/c3.jpg" alt=" " class="img-responsive" />
                            </div>
                        </div>
                        <div class="w3layouts_work_grid_right">
                            <h4>
                    ...
                    <li>
                        <div class="w3layouts_work_grid_left">
                            <img src="/images/hotel/5.jpg" alt=" " class="img-responsive" />
                            <div class="w3layouts_work_grid_left_pos">
                                <img src="/images/hotel/c4.jpg" alt=" " class="img-responsive" />
                            </div>
                        </div>
                        <div class="w3layouts_work_grid_right">
                            <h4>
